...
var stripe = Stripe('pk_test_51OxxnrLF8bVK9sNB77xKNhVK4UZT3Q92gkvoZlGBnUYnvPuxwQTrATF9gNmXxpuUBUN0vFCNB6IqSXwabjCsdyMY00mFKicbyE');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://localhost:8000/api/v1/booking/checkout-session/".concat(tourId));
        case 3:
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)(_context.t0.message);
        case 11:
        case "end":
          return _context.stop();
      }
